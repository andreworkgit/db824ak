...
Modernizr.load({
  ...
  nope: 'admin_files/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['admin_files/ios-orientationchange-fix.js', 'admin_files/jquery.ui.touch-punch.min.js']
});
...
$(document).ready(function(){ 	
	...
	if(supr_Options.rtl) {
		...
		$('#bootstrap').attr('href', 'admin_files/bootstrap.rtl.min.css');
		$('#bootstrap-responsive').attr('href', 'admin_files/bootstrap-responsive.rtl.min.css');
		$('body').addClass('rtl');
